...
def def_slide(slide_num):


    slide_num = 28
    fname_login = '/Users/arcucci.v/Desktop/MIBIscan/ScanningSlides/MIBItracker_login_Valeria.dat'
    ...
    single_slide = mr.get('/slides/{}/'.format(slide_num)).json()
    ...
    ## SLIDE 13
    #slideID = 34
    #patient_map = {0:'13MH0599', 1: '12MH0960' ,2: '11SH0770', 3: '14MH1100', 4: '11CH0166', 5:'12MH1213', 6:'Tonsil'}
    #section_map = {0: 160, 1: 163 ,2: 161, 3: 164, 4: 162, 5:165, 6:166}

    ## SLIDE 03
    #slide_id = 24
    #patient_order = {0:'TOP 14MH1018', 1: '14PM0855' ,2: '12MH0122', 3: '14MH0174', 4: '13PM0868', 5:'12MH0204', 6:'Tonsil'}
    #section_map = {0: 90, 1: 91 ,2: 94, 3: 92, 4: 95, 5:93, 6:96}

    ## SLIDE 08
    #slideID = 29
    #FROM TOP TO BOTTOM
    #patient_order = {0: 'TOP RIGHT 11MH1047', 1: '14MH1032', 2: '12MH1260', 3: '17MH0050', 4: '12MH0241', 5:'13MH0025', 6: '12SH0229', 7: '14MH0626', 8:'BOTTOM RIGHT'}
    #section_map = {0: 124, 1: 128, 2: 125, 3: 126, 4: 127, 5:129, 6: 131, 7: 130,  8: 132}

    ##SLIDE 11
    #patient_order = {0: 'TOP 12MH0925', 1: '14MH0637', 2: '12MH0800', 3: '13MH0696', 4:'13MH1064',5: 'BOTTOM RIGHT'}

    ##SLIDE 06
    #patient_order = {0: 'TOP 13MH0371', 1: '12PM1124', 2: '12MH1259', 3: '17AH0147', 4:'17MH0012', 5: '14MH0363',6: '12PM115', 7: 'BOTTOM RIGHT'}

    ##SLIDE 02
    #patient_order = {0: 'TOP 13AH0406', 1: '13MH0622', 2: '11MH0691', 3: '14MH0647', 4:'13MH0792', 5:'BOTTOM RIGHT'}

    ##SLIDE 16
    #patient_order = {0: 'TOP 12MH1360', 1: '14MH0439', 2: '13PM1200', 3: '14MH0181', 4: '12MH0620', 5:'14MH0351', 6: '17MH0068', 7: '13AH0179',  8:'BOTTOM RIGHT', 9:'11MH0979', 10:'12AH0461'}

    ##SLIDE 07
    patient_order = {0: 'TOP 15MH0258', 1: '12SH095', 2: '13MH1053', 3: '12MH1099', 4: 'BOTTOM RIGHT'}

    ##SLIDE 12
    #patient_order = {0: 'TOP 12BH0194', 1: '14MH0162', 2: '12SH0270', 3: '13MH0007', 4: '12PM1068', 5: 'BOTTOM RIGHT', 6: '17AH0219'}

    ##SLIDE 01
    #patient_order = {0: '12MH0716', 1: '11MH0927', 2: 'BOTTOM RIGHT'}

    ##SLIDE 10
    #patient_order = {0: 'TOP 13MH1041', 1: '12PM0950', 2: '13MH0308', 3: '13MH0383', 4: '12MH1259', 5: '12BH0102', 6: 'BOTTOM RIGHT'}

    ##SLIDE 14
    #patient_order = {0: '11MH0285', 1: 'TOP 13MH0737', 2: '11AH0644', 3: '12SH0284', 4: '14MH0424', 5: '13PM0638', 6: 'BOTTOM RIGHT'}

    ##SLIDE 09
    #patient_order = {0: 'TOP 14MH0636', 1: '17AH0200', 2: '15MH0013', 3: '11SH0684', 4: '13MH0255', 5: 'BOTTOM RIGHT'}

    ##SLIDE 4
    #patient_order = {0: 'TOP 12PM1049', 1: '13AH0353', 2: '17MH0078', 3: 'BOTTOM RIGHT'}

    ##SLIDE 15
    #patient_order = {0: 'TOP 12MH0800', 1: '11MH0594', 2: '12MH0544', 3: '13MH0295', 4: '12MH0365', 5: '13MH1289', 6: '13MH0750', 7: '12MH0800',  8: '11SH0636', 9: '12AH0391', 10: 'BOTTOM RIGHT'}
...
def main():
    ...
    PATH = '/Users/arcucci.v/Desktop/MIBIscan/ScanningSlides/ihc-mibi-transform/data/'
    fov_size = 400
    slide_num = 7
    if slide_num < 10:
    ...
    source_image = load_jpg(f'{PATH}/MIBI_CM21-{slide_num}.png')
    target_image = load_jpg(f'{PATH}/MIBI_CM21-{slide_num}_he.jpg')
    ...
    if SAVE_HE:
        io.imsave(f'{PATH}MIBI_CM21-{slide_num}_transformed_final.png', transformed_target)

    if LOAD_HE:
        transformed_target = load_jpg(f'{PATH}MIBI_CM21-{slide_num}_transformed_final.png')
    ...
    patient_info = def_slide(int(slide_num))
